...
namespace StackOverflow
{
    public partial class StackOverflowClient
    {
        ...
        {
            return GetUserMentions(userId, new UserOptions());
        }

        public virtual IPagedList<Comment> GetUserMentions(int userId, UserOptions options)
        {
        ...
        {
            return GetUserMentions(userIds, new UserOptions());
        }

        public virtual IPagedList<Comment> GetUserMentions(IEnumerable<int> userIds, UserOptions options)
        {
